...
import org.ipoliakov.dmap.util.concurrent.lock.DmapStampedLock;
...
public class ConcurrentOptimisticMap<K, V> implements ConcurrentMap<K, V> {
    ...
    private static class SetView<K> extends AbstractSet<K> {
        ...
        public boolean equals(Object o) {
            return lock.readLocked(() -> sourceSet.equals(o));
        }

        @Override
        public int hashCode() {
            return lock.readLocked(sourceSet::hashCode);
        }

        @Override
        public String toString() {
            return lock.readLocked(sourceSet::toString);
        }
    }
